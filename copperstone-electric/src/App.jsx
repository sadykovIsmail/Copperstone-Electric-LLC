...
import { Zap, Phone, Mail, MapPin, Menu, X, Star, ArrowRight, CheckCircle } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: BG, color: DARK, minHeight: "100vh" }}>
      ...
      {/* ── HERO — tools workshop photo as background ── */}
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(15,10,6,0.88) 45%, rgba(15,10,6,0.4) 100%)" }} />
        <div style={{ position: "relative", maxWidth: 1100, margin: "0 auto", padding: "110px 32px 80px", width: "100%" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.4rem,5.5vw,4.2rem)", fontWeight: 900, lineHeight: 1.1, color: "#fff", margin: "0 0 20px", maxWidth: 580 }}>
            Expert Electrical Services<br />
            <span style={{ color: C }}>Done Right.</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.72)", fontSize: 16, maxWidth: 460, lineHeight: 1.8, margin: "0 0 36px" }}>
            Texas-licensed electrical contractor specializing in commercial builds, panel upgrades, and large-scale residential work.
          </p>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 48 }}>
            <a href="#contact" style={{ background: C, color: "#fff", padding: "14px 28px", borderRadius: 6, fontWeight: 700, fontSize: 14, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8 }}>
              Get in Touch <ArrowRight size={14} />
            </a>
            <a href="#services" style={{ border: "1px solid rgba(255,255,255,0.3)", color: "#fff", padding: "14px 24px", borderRadius: 6, fontWeight: 600, fontSize: 14, textDecoration: "none" }}>
              Discover More
            </a>
          </div>
      ...
      <section style={{ background: DARK, padding: "64px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 40 }} className="benefits-grid">
          {[
            { title: "Licensed & Certified",  desc: "TECL licensed, fully insured, and code-compliant on every job." },
            { title: "Customer Satisfaction", desc: "Most of our clients come back. That's the standard we hold ourselves to." },
            { title: "Commercial Experience", desc: "We know job sites, trade sequencing, and how to keep a project on schedule." },
            { title: "Reliable Execution",    desc: "Organized, documented work that holds up to inspection every time." },
          ].map(({ title, desc }) => (
            <div key={title}>
      ...
      <section id="services" style={{ background: BG, padding: "96px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3.5vw,2.6rem)", fontWeight: 900, lineHeight: 1.1, marginBottom: 14 }}>Our Services</h2>
            <p style={{ color: GRAY, maxWidth: 480, margin: "0 auto", fontSize: 15, lineHeight: 1.8 }}>
              We focus on serious jobs — commercial builds, full rewires, panel upgrades, and EV infrastructure.
            </p>
          </div>
            ...
            {[
              {
                ...
                tag: "Primary Focus",
                desc: "New construction wiring, tenant build-outs, panel upgrades, lighting systems, and emergency power — full scope, start to finish.",
              ...
              },
              {
                ...
                desc: "We take on residential projects that require real expertise — full rewires, major panel replacements, and EV charging infrastructure.",
                items: ["Full Home Rewiring", "Panel Replacements (200A+)", "EV Charger Installation", "Whole-Home Surge Protection"],
              },
              {
                title: "Preventive Maintenance",
                tag: "Ongoing Service",
                desc: "Scheduled inspections and maintenance programs to keep commercial facilities running safely without unplanned downtime.",
                items: ["Scheduled Inspections", "Code Compliance Checks", "System Testing", "Emergency Response"],
              },
      ...
      {/* ── ABOUT — electrician portrait + text ── */}
      <section id="about" style={{ background: DARK, padding: "0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }} className="photo-split">
          <div style={{ position: "relative", minHeight: 520 }}>
            ...
            <div style={{ position: "absolute", inset: 0, background: "rgba(15,10,6,0.25)" }} />
          </div>
          <div style={{ padding: "80px 64px", display: "flex", flexDirection: "column", justifyContent: "center" }} className="about-text">
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3vw,2.6rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 24 }}>
              ...
              <span style={{ color: C }}>Professionally Executed.</span>
            </h2>
            <p style={{ color: "#9A9088", fontSize: 15, lineHeight: 1.85, marginBottom: 16 }}>
              Copperstone Electric LLC is a licensed electrical contractor based in Texas, focused on commercial electrical projects and large-scale residential work that requires real expertise.
            </p>
            <p style={{ color: "#7A7060", fontSize: 15, lineHeight: 1.85, marginBottom: 36 }}>
              We work with general contractors, property managers, developers, and business owners who need electrical done correctly — on schedule, to code, and built to last.
            </p>
      ...
      {/* ── TESTIMONIALS ── */}
      <section id="testimonials" style={{ background: BG2, padding: "96px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              <div style={{ width: 36, height: 1, background: C }} />
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3.5vw,2.4rem)", fontWeight: 900, marginBottom: 12 }}>What Our Clients Say</h2>
            <div style={{ display: "flex", justifyContent: "center", gap: 3, marginTop: 8 }}>
              {[...Array(5)].map((_, i) => <Star key={i} size={16} fill={C} color={C} />)}
            </div>
            <p style={{ color: GRAY, fontSize: 13, marginTop: 8 }}>5.0 · 80+ Google Reviews</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 24 }} className="services-grid">
            {[
              { name: "Marcus T.", role: "Property Manager", quote: "Copperstone did a full panel upgrade and tenant build-out for our commercial property. Professional crew, on schedule, and zero issues at inspection. Will use again." },
              { name: "Jennifer R.", role: "General Contractor", quote: "I've worked with a lot of electrical subs. These guys show up, do clean work, and communicate clearly. That's rare. They're my first call for commercial projects." },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 72, alignItems: "start" }} className="split-grid">
            <div>
              ...
              <h2 style={{ fontSize: "clamp(1.8rem,3vw,2.6rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 12 }}>
                Have a Project?<br />
                <span style={{ color: C }}>Let's Talk.</span>
              </h2>
              <p style={{ color: "#7A7060", fontSize: 15, lineHeight: 1.8, marginBottom: 36 }}>
                We work with commercial clients, contractors, and property managers across Texas.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                {[
                  { icon: Phone, value: "(713) 555-0199",              sub: "24/7 for emergencies" },
              ...
              {submitted ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                  ...
                  <button onClick={handleSubmit}
                    style={{ background: C, color: "#fff", border: "none", borderRadius: 6, padding: "14px 0", fontWeight: 700, fontSize: 15, cursor: "pointer" }}>
                    Submit Request
                  </button>
                </div>
              )}
...
function ServiceCard({ title, tag, desc, items }) {
  return (
    <div style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: 12, padding: "32px 28px" }}>
      <span style={{ color: C, fontSize: 10, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase", display: "block", marginBottom: 16 }}>{tag}</span>
      <h3 style={{ color: DARK, fontWeight: 800, fontSize: 18, lineHeight: 1.2, marginBottom: 14 }}>{title}</h3>
      <p style={{ color: GRAY, fontSize: 14, lineHeight: 1.75, marginBottom: 24 }}>{desc}</p>
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        {items.map(item => (
